...
Unrolling an RNN for several steps results in multiple products with W and applying tanh multiple times.
...
* Output gate: how much to reveal to cell (read)
...
* Bi-directional RNN
* Tree-structured RNN
* RNNs for 2D Sequences
* RNNs for Graph Structures
