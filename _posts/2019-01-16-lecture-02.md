...
_Soundness_: $$ X, Y $$ are d-separated given $$ Z $$ implies $$ X \perp Y|Z $$, i.e. independence determined by d-separation is satisfied by the underlying distribution. 
_Completeness_:  If $$ X \perp Y | Z $$ then they are d-separated, i.e. d-separation detects all possible independencies.
