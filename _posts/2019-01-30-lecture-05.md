...
## Introduction
Last class, we presented two major types of graphical model task, **Inference** and **Learning**, and we mainly discussed about inference. In this lecture, we start to introduce the learning tasks, and explore some learning techniques used in **fully observable Bayesian Networks**.
...
The goal of parameter learning is to estimate parameters from a dataset of $N$ independent, indentically distributed (i.i.d.) training samples $D = \{x_1, ..., x_N\}$. 
