...
There are various density estimation tasks that can be viewed as single-node GMs (see supplementary section for examples), and they are in fact instances of **Exponential Family Distrubution**. 

Exponential Family Distrubutions are building blocks for general GM, and have nice properties allowing us to easily do MLE and Bayesian estimation.
