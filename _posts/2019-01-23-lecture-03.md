...
Given an undirected graph $$H$$, clique potentials are a set of positive functions $$\psi_C$$ associated with cliques of $$H$$.

Then we say $$P(X_1, ..., X_n)$$ is a **Gibbs distribution** over $$H$$ if it can be represented as
$$
