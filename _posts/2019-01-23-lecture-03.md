...
Definition: Given an undirected graph $$H$$ and clique potentials functions $$\psi_C$$ associated with cliques of $$H$$, we say $$P(X_1, ..., X_n)$$ is a **Gibbs distribution** over $$H$$ if it can be represented as
