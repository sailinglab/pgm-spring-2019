...
If the state space is high-dimensional or infinite, it is not feasible to represent $$Q, V$$ in a tabular form. In this case, we use two parameterized functions $$Q_\phi, V_\phi$$ to denote them. Then, we adopt fitted Q-iteration as stated in [this paper]([http://www.jmlr.org/papers/volume6/ernst05a/ernst05a.pdf](http://www.jmlr.org/papers/volume6/ernst05a/ernst05a.pdf)):
