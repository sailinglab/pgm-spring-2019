...
$$ P(X_{2})\rightarrow 1 $$ parameter 

$$ P(X_{3}|X_{1})\rightarrow 2 $$ parameters 

$$ P(X_{4}|X_{2})\rightarrow 2 $$ parameters
...
Meanwhile, with a full joint distribution table, we would need $ 2^{8}-1 $ parameters.</li>
