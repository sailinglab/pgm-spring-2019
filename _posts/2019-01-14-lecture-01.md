...
<figure id="sample-graph" class="l-body-outset">
  <div class="row">
...
<figure id="graph-families" class="l-body-outset">
  <div class="row">
    <div class="col one">
      <img src="{{ 'assets/img/notes/lecture-01/dag.jpg' | relative_url }}" />
      <figcaption>
    ...
    <div class="col one">
      <img src="{{ 'assets/img/notes/lecture-01/undirected.jpg' | relative_url }}" />
      <figcaption>
