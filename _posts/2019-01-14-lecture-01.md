...
<ol>
  <li>Cost savings in representing the joint distribution.
...
Therefore, the problem of joint distribution estimation can be modularized into smaller pieces and integrated later by multiplication.
    ...
    <dl>Examples:
        ...
        <dd>- one lab can study the subtree formed by $X_{1}, X_{3}, X_{6}, X_{7}, X_{8}$ while another lab can study $X_{2}, X_{4}, X_{5}$, then fuse their estimations together by multiplying the terms by their dependencies.</dd>
