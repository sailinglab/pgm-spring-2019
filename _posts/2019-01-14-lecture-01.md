...
Graphical models allow us to address three major questions:
...
Each of this questions can be rephrased as a question about probability distributions:
...
3. How can we compute conditional distributions of unobserved (latent) variables given our limited evidence?
