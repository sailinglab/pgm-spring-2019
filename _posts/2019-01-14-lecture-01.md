...
By factoring the joint distribution into modular terms, each term becomes self-contained and we can estimate each term with only the relevant datapoints </li>
(e.g. to estimate $$ P(X_{8}|X_{5}, X_{6}) $$ we only need data for $$ X_{8}, X_{5} and X_{6} $$)
