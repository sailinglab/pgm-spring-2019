...
<d-math block>
\begin{aligned}
P(y_i | x_1, \dots, x_T) &= \sum_{y_1} \dots \sum_{y_{i-1}} \sum_{y_{i+1}} \dots \sum_{y_T} P(y_1, \dots, y_T, x_1, \dots, x_T) \\
&= \sum_{Y_1} \dots \sum_{Y_{i-1}} \sum_{Y_{i+1}} \dots \sum_{Y_T} P(y_1) P(x_1 | y_1) P(y_2 | y_1) \dots P(y_T | y_{T-1}) P(x_T | y_T) \\  
\end{aligned}
</d-math>
...
%<d-math block>
%\begin{aligned}
%P(y_i | x_1, \dots, x_T) &= \sum_{y_2} \dots \sum_{Y_{i-1}} \sum_{Y_{i+1}} P(x_2 | y_2) P(y_3 | y_2) \dots \sum_{Y_T} P(y_1) %P(x_1 | y_1) P(y_2 | y_1) \dots P(y_T | y_{T-1}) P(x_T | y_T) \sum_{y_1} P(y_1) P(x_1 | y_1) P(y_2 | y_1)\\  
%&= \sum_{y_2} \dots \sum_{Y_{i-1}} \sum_{Y_{i+1}} P(x_2 | y_2) P(y_3 | y_2) \dots \sum_{Y_T} P(y_1) P(x_1 | y_1) P(y_2 | y_1) %\dots P(y_T | y_{T-1}) P(x_T | y_T) \phi(x_1, y_2) \\  
%\end{aligned}
%</d-math>
...
3 - mention Junction tree algorithm that extends Sum-product to general graphs by combining it with elimination; junction tree is the same as clique tree (also sometimes called Join tree); Constructing junction tree is computationally exp (NP-hard)
