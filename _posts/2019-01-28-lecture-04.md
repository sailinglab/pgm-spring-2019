...
We can define the **width** of a reconstituted graph as the size of largest clique minus 1. Let $w_{G,I}$ be the width of $G’_I(V, E’)$. For different ordering $I$ $w_{G,I}$ will be different. Now we define **tree-width** of $G$ as:
