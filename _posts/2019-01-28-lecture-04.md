...
<d-math block>
\begin{aligned}
P(y_i | x_1, \dots, x_T) &= \sum_{y_2} \dots \sum_{Y_{i-1}} \sum_{Y_{i+1}} \dots \sum_{Y_T} P(y_1) P(x_1 | y_1) P(y_2 | y_1) \dots P(y_T | y_{T-1}) P(x_T | y_T) \sum_{y_1} P(y_1) P(x_1 | y_1) P(y_2 | y_1)\\  
