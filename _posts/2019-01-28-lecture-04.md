...
<script type="math/tex; mode=display"> \mathrf{MPA}(Y | e) = arg\max_{\mathbf{y} \in \mathcal{Y} } P(\mathbf{y} | \mathbf{e}) = arg\max_{\mathbf{y} \in \mathcal{Y} } P(\mathbf{y}, \mathbf{z} | \mathbf{e}) </script>.
