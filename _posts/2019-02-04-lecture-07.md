...
$$
\psi_c(c_1,c_2,c_3) \propto exp\{\theta_{ing}f_{ing}(c_1,c_2,c_3)} + \theta_{?ed}f_{?ed}(c_1,c_2,c_3) + \theta_{qu?}f_{qu?}(c_1,c_2,c_3) +  ... \} 
$$
