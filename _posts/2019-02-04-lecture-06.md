...
1. A set of N states, $\mathbf{y} = y_1,y_2,...,y_N$
2. Transition probability between any two states
...
\end{aligned}
$$
3. Output observations, $\mathbf{x} = x_1, x_2,\ldots,x_T $
4. Emmision Probabilities, the probability of an observation being generated from a state.
...
\end{aligned}
$$
5. Start or prior probabilities 
